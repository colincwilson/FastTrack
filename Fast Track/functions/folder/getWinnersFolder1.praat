# Get winning formats for one file

procedure getWinnersFolder1
    # Transfer state from getWinnersFolder [new]
    .file_info = getWinnersFolder.file_info
    .counter = getWinnersFolder.counter
    .basename$ = getWinnersFolder.basename$
    .winners = getWinnersFolder.winners
    .cutoffs# = getWinnersFolder.cutoffs#
    appendInfoLine: "getWinnersFolder1 start", tab$, .basename$
    ...
    appendInfoLine: "getWinnersFolder1 done", tab$, .basename$
